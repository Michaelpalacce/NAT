...
export const DEFAULT_BTVA_VERSION = '2.36.0';
export const DEFAULT_WATCH_MS = 1000;
export const DEFAULT_CONNECTION_NAME = "Aria";
export const DEFAULT_DESCRIPTION = "Generated by NAT";
...
export function parseArguments(): CliOptions {
	return parse<CliOptions>(
		{
			// META
			help: { type: Boolean, defaultValue: false, description: "Displays Help" },
			version: { type: Boolean, defaultValue: false, description: "Current version of the tool" },
			verbosity: { type: String, defaultValue: "info", description: "Logging verbosity: error, warn, info, http, verbose, debug, silly" },

			// INIT
			init: { type: Boolean, defaultValue: false, description: "Initialize NAT dependencies, downloads vrotsc, vropkg and vrotest from maven central" },
			...
			btvaVersion: { type: String, defaultValue: DEFAULT_BTVA_VERSION, description: "Init: Specifies the btva version to use when initializing vropkg, vrotsc and vrotest" },

			// Build + Push
			clean: { type: Boolean, defaultValue: false, alias: "x", description: "Cleans up the NAT folder" },
			dependencies: { type: Boolean, defaultValue: false, alias: "d", description: "Fetch project dependencies" },
			...
			watchMs: { type: Number, defaultValue: DEFAULT_WATCH_MS, alias: "W", description: "How long should we debounce the recompillation." },
			...
			description: { type: String, defaultValue: DEFAULT_DESCRIPTION, description: "The description of the generated package. This will be visible in Orchestrator" },
